        ...
        <div class="login-box">
            ...
            <div class="card">
                <div class="card-body login-card-body">
                    <p class="login-box-msg text-info">Faça o login para iniciar sua sessão</p>

                    <form class="needs-validation" novalidate id="formLogin"  action="<?php echo BASE_URL; ?>/login/checkLogin" method="post">
                        <!-- Usuário -->
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Usuário"  name="edlogin" required>
                        ...
                        <div class="social-auth-links text-center mb-3">
                            <button type="submit" class="btn bg-info btn-block"> Entrar</button>
                        </div>
