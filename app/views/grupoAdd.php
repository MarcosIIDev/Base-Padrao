<section class="content-header sessTit">
    <div class="container-fluid">
        <div class="row mb-2">
            <!-- Título -->
            <div  class="col-sm-6">
                <h1 style="font-size: 25px;">Adicionar Grupo</h1>
            </div>
            <!-- Lado Direito -->
            <div class="col-sm-6">
...
<section class="content sessMargin">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="needs-validation" novalidate method="POST" id="formGrupo" action="<?php echo BASE_URL; ?>/grupo/addMod" data-toggle="validator" role="form">
                ...
                <div class="modal-body">
                    ...
                    <div class="row"> 
                        <div class="form-group col-sm-12 form-group-sm">
                            ...
                            <input type="text" class="form-control text-uppercase" name="edgrupo"  maxlength="50" value="" required autofocus>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="icheck-primary d-inline">
                                            <input type="checkbox" class="flat-red uppercase" name="permissoes[]" value="<?php echo $linha['prm_id']; ?>"  id="perm-<?php echo $linha['prm_id']; ?>">
