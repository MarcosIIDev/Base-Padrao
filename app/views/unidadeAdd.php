<section class="content-header sessTit">
    <div class="container-fluid">
        <div class="row mb-2">
            <!-- Título -->
            <div  class="col-sm-6">
                <h1 style="font-size: 25px;">Adicionar Unidade</h1>
            </div>
            <!-- Lado Direito -->
            <div class="col-sm-6">
...
<section  class="content sessMargin">
    ...
    <form class="needs-validation" novalidate id="formUnidade" name="formUnidade" action="<?php echo BASE_URL; ?>/unidade/addMod" method="post">
        <!-- Abas -->
        <nav>
            ...
            <div class="tab-pane fade show active" id="tab01" role="tabpanel" aria-labelledby="nav-home-tab">
                ...
                <div class="form-row">
                    <div class="form-group col-md-10">
                        ...
                        <input type="text" class="form-control text-uppercase" id="edunidade" name="edunidade" maxlength="100" placeholder="" required />
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control text-uppercase" id="edend" name="edend" maxlength="100" />
                    </div>
                    <div class="form-group col-md-3">
                        <label for="edbairro">Bairro</label>
                        <input type="text" class="form-control text-uppercase" id="edbairro" name="edbairro" maxlength="30" />
                    </div>
                    <div class="form-group col-md-2">
                        <label for="edcidade">Cidade</label>
                        <input type="text" class="form-control text-uppercase" id="edcidade" name="edcidade" maxlength="30" required />
                        <div class="invalid-feedback">Digite uma Cidade </div>
                    </div>
                    <div class="form-group col-md-1">
                        <label for="eduf">UF</label>
                        <input type="text" class="form-control text-uppercase" id="eduf" name="eduf" maxlength="2" value="DF" required />
                    </div>
                </div>   
                <!-- Linha 04 -->
                <div class="form-row">
                    <div class="form-group col-md-2">
                        ...
                        <input type="text" class="form-control" id="edcep" name="edcep" maxlength="10" placeholder="70.000-000" onkeypress="$(this).mask('00.000-000')" />
                    </div>
                    <div class="form-group col-md-2">
                        <label for="edfone1">Fone Com.</label>
                        <input type="text" class="form-control" id="edfone1" name="edfone1" maxlength="14" placeholder="(61) 3333-3333" onkeypress="$(this).mask('(00) 0000-0000')" required />
                        <div class="invalid-feedback">Digite um número de Telefone</div>
                    </div>
                    <div class="form-group col-md-2">
                        <label for="edfone2">Fone/Fax</label>
                        <input type="text" class="form-control" id="edfone2" name="edfone2" maxlength="14" placeholder="(61) 4444-4444" onkeypress="$(this).mask('(00) 0000-0000')" />
                    </div>
                    <div class="form-group col-md-6">
                        <label for="edemail">Email</label>
                        <input type="email" class="form-control text-lowercase" id="edemail" name="edemail" maxlength="50" placeholder="email válido" />
                    </div>
                </div>   
                <!-- Linha 05 -->
                <div class="form-row">
                    <div class="form-group col-md-10">
                        ...
                        <input type="text" class="form-control text-uppercase" id="edresp" name="edresp" maxlength="100" required />
                        <div class="invalid-feedback">Digite o nome do Responsável pela Unidade</div>
                    </div>
                    <div class="form-group col-md-2">
                        <label for="edrespfone">Fone do Resp.</label>
                        <input type="text" class="form-control" id="edrespfone" name="edrespfone" maxlength="15"  placeholder="(61) 99999-9999" onkeypress="$(this).mask('(00) 00000-0000')" />
                    </div>
                </div>  
            ...
            <div class="tab-pane fade" id="tab02" role="tabpanel" aria-labelledby="nav-profile-tab">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control" id="edobs" name="edobs" rows="15" ></textarea>
                    </div>
                </div>
            </div><!-- /Aba Observações -->
