<section class="content-header sessTit">
    <div class="container-fluid">
        <div class="row mb-2">
            <!-- Título -->
            <div  class="col-sm-6">
                <h1 style="font-size: 25px;">Adicionar Usuário</h1>
            </div>
            <!-- Lado Direito -->
            <div class="col-sm-6">
...
<section  class="content sessMargin">
    ...
    <form class="needs-validation" novalidate id="formUsuario" name="formUsuario" action="<?php echo BASE_URL; ?>/usuario/addMod" method="post" enctype="multipart/form-data">
        <!-- Abas -->
        <nav>
            ...
            <div class="tab-pane fade show active" id="tab01" role="tabpanel" aria-labelledby="nav-home-tab">
                ...
                <div class="row">
                    <div class="form-group form-group-sm col-md-6">
                        ...
                        <input type="text" class="form-control text-uppercase" name="edusuario" id="edusuario" maxlength="100" required value="">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="email" class="form-control text-lowercase" id="edemail" name="edemail" maxlength="50" />
                ...
                <div class="row">
                    <div class="form-group form-group-sm col-md-6">
                        ...
                        <input type="text" class="form-control text-lowercase" name="edlogin" id="edlogin" maxlength="15" required >
                        <div class="invalid-feedback">Digite um Login</div>
                    </div>
                    <div class="form-group form-group-sm col-md-6">
                        <label for="edsenha" class="control-label">Senha </label>
                        <input type="password" class="form-control text-uppercase" name="edsenha" id="edsenha" maxlength="10" required value="12345678">
                ...
                <div class="row">
                    <div class="form-group form-group-sm col-md-12">
                        ...
                        <select class="form-control" name="edgrupo" id="edgrupo" value="" required>
                            <option value="" >SELECIONE UM GRUPO</option>
                            <?php foreach ($listGrupos as $linha): ?>
                                <option value="<?php echo $linha['grp_id'] ?>" ><?php echo $linha['grp_grupo'] ?></option>
                            <?php endforeach; ?>
                        </select>
            ...
            <div class="tab-pane fade" id="tab02" role="tabpanel" aria-labelledby="nav-profile-tab">
                ...
                <div class="form-row">
                    <div class="form-group col">
                        ...
                        <textarea style="max-height: 217px" class="form-control" id="edobs" name="edobs" rows="9" ></textarea>
                    </div>
                    <div class="form-group col-md-2">
                        <label for="edobs">Foto</label>
                        <div class="text-center">
                            <img name="edfoto" src="<?php echo BASE_URL; ?>/assets/imagens/user/no-photo.png" width="256" alt="Foto" class="img-thumbnail"> <br/>
                    ...
                    <div class="form-group col">
                        ...
                        <div class="input-group">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="edfile" id="edfile" lang="pt-br" onchange="previewImagem()" />
